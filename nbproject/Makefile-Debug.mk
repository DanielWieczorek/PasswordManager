...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/passwordmanager: ../dwilib/dist/Debug/GNU-MacOSX/libdwilib.a
...
${OBJECTDIR}/_ext/351423432/passwordgenerator.o: ../passwordmanager/src/passwordgenerator.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/351423432/passwordgenerator.o ../passwordmanager/src/passwordgenerator.c
...
${OBJECTDIR}/src/base64.o: src/base64.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/base64.o src/base64.c
...
${OBJECTDIR}/src/persistence.o: src/persistence.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/persistence.o src/persistence.c
...
${TESTDIR}/TestFiles/f4: ${TESTDIR}/test/core_test.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/test/core_test.o: test/core_test.c 
	${MKDIR} -p ${TESTDIR}/test
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/test/core_test.o test/core_test.c
...
${TESTDIR}/_ext/1990793406/passwordgenerator_test.o: ../passwordmanager/test/passwordgenerator_test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1990793406/passwordgenerator_test.o ../passwordmanager/test/passwordgenerator_test.c


${TESTDIR}/test/persistence_test.o: test/persistence_test.c 
	${MKDIR} -p ${TESTDIR}/test
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/test/persistence_test.o test/persistence_test.c
...
${OBJECTDIR}/_ext/351423432/passwordgenerator_nomain.o: ${OBJECTDIR}/_ext/351423432/passwordgenerator.o ../passwordmanager/src/passwordgenerator.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/351423432/passwordgenerator_nomain.o ../passwordmanager/src/passwordgenerator.c;\
	else  \
...
${OBJECTDIR}/src/base64_nomain.o: ${OBJECTDIR}/src/base64.o src/base64.c 
	${MKDIR} -p ${OBJECTDIR}/src
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/base64_nomain.o src/base64.c;\
	else  \
...
${OBJECTDIR}/src/persistence_nomain.o: ${OBJECTDIR}/src/persistence.o src/persistence.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/persistence_nomain.o src/persistence.c;\
	else  \
...
# Subprojects
.clean-subprojects:
	cd ../dwilib && ${MAKE}  -f Makefile CONF=Debug clean
